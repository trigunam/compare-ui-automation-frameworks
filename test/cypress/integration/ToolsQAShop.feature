Feature: Shopping on Tools QA
  ...
  Scenario: Placing Order for 2 Shirts
    ...
    And I do the registration for my user by entering username as "aashishk17" and email address as "aashish.khetarpal.07@gmail.com" and password as "cypre$stut0rials"
    ...
    And I do the login with same credentials used above "aashish.khetarpal.07@gmail.com" and "cypre$stut0rials"
